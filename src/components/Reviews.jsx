    ...
    <div className="">
      ...
      <div className="md:mt-32 mt-10">
        <div
          ...
          className="text-center pb-6 border-b-2 border-dashed"
        >
          <h3 className="text-4xl font-extrabold font-garamond">
            Latest Reviews
          </h3>
            ...
            <div className="flex gap-8">
              <div className="text-center p-4  shadow-xl rounded-xl w-96">
                ...
                <div>
                  ...
                  <p className="text-lg font-medium opacity-80 mt-4">
                    ❝Exceptional experience, exceeded expectations. Found my
                    dream waterfront oasis.❞
                  </p>
              ...
              <div className="text-center p-4  shadow-xl rounded-xl w-96 ">
                ...
                <div>
                  ...
                  <p className="text-lg font-medium opacity-80 mt-4">
                    ❝Breathtaking properties, impeccable service. Found my dream
                    home effortlessly. Highly recommend❞
                  </p>
              ...
              <div className=" text-center p-4  shadow-xl rounded-xl w-96 ">
                ...
                <div>
                  ...
                  <p className="text-lg font-medium opacity-80 mt-4">
                    ❝Exquisite homes, top-notch service. Perfect getaway,
              ...
              <div className="text-center p-4  shadow-xl rounded-xl w-96 mr-8">
                ...
                <div>
                  ...
                  <p className="text-lg font-medium opacity-80 mt-4">
                    ❝Unmatched upscale living. Outstanding staff, seamless
                    buying process.❞
                  </p>
